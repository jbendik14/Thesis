...
class DNNModel:
    ...
    def train(self, x, y, rep):
        ...
        self.model.fit(x, y, epochs= 5, batch_size = 128, verbose = 0, shuffle=True)
    ...
    def cross(self, x, y, rep):
        ...
        for train, val in kfold.split(x, y.argmax(axis = 1)):
            ...
            model.summary()
            history = model.fit(x[train], y[train], epochs = 5, batch_size = 128, validation_data=(x[val], y[val]), verbose = 0)
